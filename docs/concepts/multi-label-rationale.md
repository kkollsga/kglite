...
| Save / load | RGF v6/Postcard carries a dedicated secondary-label section and round-trips preserve secondaries; pre-0.14 bincode containers require conversion with 0.13.4 |
