...
#
# Phase A.1 / C5 bumped the .kgl format from v3 to v4 (hard break; v3 files
# no longer load). The four fixture .kgl files under tests/fixtures/ were
# regenerated for v4 by tests/fixtures/build_fixtures.py at the 0.9.53
# release. Re-run that script if the format bumps again (deterministic via
# random.seed(42); produces byte-identical output across runs).
