...
Two failure modes motivated this file, both of which look like a green run:
...
Both checks run anywhere, which is the point: the platform that breaks is not
the platform that runs CI first.
"""
