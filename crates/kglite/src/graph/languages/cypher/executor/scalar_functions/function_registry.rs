...
pub(crate) const FUNCTIONS: &[FunctionSpec] = &[
    ...
    FunctionSpec {
        ...
        aliases: &[],
        category: "utility",
        description: "Whether an entity's closed validity interval covers a date; null bounds are open, a date string reads as date() does",
    ...
    FunctionSpec {
        ...
        aliases: &[],
        category: "utility",
        description: "Whether an entity's closed validity interval overlaps a date range; null bounds are open",
