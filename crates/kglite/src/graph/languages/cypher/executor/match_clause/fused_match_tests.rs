...
///
/// The connections are added **after** `enable_disk_mode`, deliberately: an
/// edge carried through the conversion lands in the CSR without a
/// `conn_type_index_*`, and the fast path's typed branch reads that index.
